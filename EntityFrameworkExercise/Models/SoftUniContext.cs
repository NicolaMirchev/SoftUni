...
namespace EntityFrameworkExercise.Models
{
    public partial class SoftUniContext : DbContext
    {
        ...
        public virtual DbSet<Cte2> Cte2s { get; set; } = null!;
        public virtual DbSet<Department> Departments { get; set; } = null!;
        public virtual DbSet<Employee> Employees { get; set; } = null!;
        public virtual DbSet<Hola> Holas { get; set; } = null!;
        public virtual DbSet<Project> Projects { get; set; } = null!;
        public virtual DbSet<Town> Towns { get; set; } = null!;
        public virtual DbSet<VTopSalaryEmployee> VTopSalaryEmployees { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=.;Database=SoftUni;User Id=sa;Password=routesetit2022");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cte2>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<Hola>(entity =>
            {
                entity.HasNoKey();
            ...
            modelBuilder.Entity<VTopSalaryEmployee>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("v_TopSalaryEmployees");
